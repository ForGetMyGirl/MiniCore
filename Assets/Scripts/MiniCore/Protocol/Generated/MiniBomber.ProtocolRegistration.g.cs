...
namespace MiniCore.Protocol.Generated
{
    ...
    public static class MiniBomberProtocolRegistration
    {
        ...
        {
            builder.RegisterMessage<MiniBomberRegisterRequest>(200003u, NetworkMessageRole.RpcRequest, new ProtobufMessageParser<MiniBomberRegisterRequest>(MiniBomberRegisterRequest.Parser));
            builder.RegisterMessage<MiniBomberRegisterResponse>(200004u, NetworkMessageRole.RpcResponse, new ProtobufMessageParser<MiniBomberRegisterResponse>(MiniBomberRegisterResponse.Parser));
            builder.RegisterMessage<MiniBomberLoginRequest>(200005u, NetworkMessageRole.RpcRequest, new ProtobufMessageParser<MiniBomberLoginRequest>(MiniBomberLoginRequest.Parser));
            builder.RegisterMessage<MiniBomberLoginResponse>(200006u, NetworkMessageRole.RpcResponse, new ProtobufMessageParser<MiniBomberLoginResponse>(MiniBomberLoginResponse.Parser));
