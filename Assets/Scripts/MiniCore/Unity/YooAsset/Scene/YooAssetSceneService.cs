...
namespace MiniCore.Service
{
    ...
    /// <summary>
    /// 基于 YooAsset 的单场景切换 Provider，遵循 Single 场景句柄释放语义。
    /// </summary>
    [AppService("YooAsset 场景", typeof(ISceneService), Description = "以 Single 模式切换业务场景并管理 SceneHandle 生命周期。", InitArgsType = typeof(YooAssetSceneServiceInitArgs), RuntimeTargets = AppServiceRuntimeTargets.Client)]
