...
namespace MiniCore.Model
{
    ...
    public sealed class UdpServer
    {
        ...
        private readonly IMTaskExecutor networkExecutor; // 服务端接收循环使用的执行器。
        ...
        /// 使用指定配置创建 UDP 服务端。
        /// </summary>
        /// <param name="config">UDP 服务端参数。</param>
        /// <param name="executor">接收循环使用的执行器；为空时按当前环境选择默认执行器。</param>
        public UdpServer(UdpServerConfig config = null, IMTaskExecutor executor = null)
        {
