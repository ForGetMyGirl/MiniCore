...
namespace MiniCore.Model
{
    ...
    public class KcpTransport : INetworkTransport
    {
        ...
        private readonly IMTaskExecutor networkExecutor;
        ...
        /// <param name="config">KCP 客户端参数。</param>
        /// <param name="executor">收包和更新循环使用的执行器；为空时按当前环境选择默认执行器。</param>
        public KcpTransport(uint conv, KcpTransportConfig config = null, IMTaskExecutor executor = null)
        {
            this.conv = conv;
