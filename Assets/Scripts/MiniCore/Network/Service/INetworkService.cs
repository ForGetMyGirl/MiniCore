...
namespace MiniCore.Service
{
    ...
    public interface INetworkService : IAppService
    {
        ...
        /// 每次主循环最多处理的入站业务包数量。
        /// </summary>
        int IncomingPacketBudgetPerUpdate { get; set; }
        /// <summary>
        /// 每次主循环用于入站派发的最大时间预算。
        /// </summary>
        TimeSpan IncomingTimeBudgetPerUpdate { get; set; }
        /// <summary>
        /// 服务端会话创建事件。
        /// </summary>
        ...
        void ConfigureProtocol(NetworkProtocolRegistry registry);
        /// <summary>
        /// 初始化默认 TCP 会话。
        /// </summary>
        ...
        /// 连接默认 WebSocket 会话。
        /// </summary>
        MTask<bool> ConnectDefaultWebSocketSessionAsync(string url, TimeSpan probeTimeout = default);
        /// <summary>
        /// 连接指定 TCP 会话。
        /// </summary>
        ...
        /// 连接指定 WebSocket 会话。
        /// </summary>
        MTask<bool> ConnectWebSocketSessionAsync(string sessionId, string url, TimeSpan probeTimeout = default);
        /// <summary>
        /// 启动 KCP 服务端。
        /// </summary>
